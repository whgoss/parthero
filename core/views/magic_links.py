...
from core.services.delivery import get_program_delivery_payload
...
def delivery_magic_link_view(request, token: str):
    ...
    return render(request, "magic_delivery.html", context)
